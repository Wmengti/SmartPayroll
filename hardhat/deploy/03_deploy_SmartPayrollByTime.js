 ...
 * @LastEditTime: 2023-06-26 11:35:18
 * @Description:
 */
...
const { smartPayrollByTimePath, smartPayrollByTimeABI } = require("../utils/config");
const fs = require("fs");
...
module.exports = async ({ deployments, getNamedAccounts }) => {
  ...
  args = [
    [
      180,
      "0x81A9205F956A1D6ae81f51977Da9702A023e199a",
  ...
  fs.writeFileSync(smartPayrollByTimeABI, smartPayrollByTimeProvider.interface.format(ethers.utils.FormatTypes.json));
