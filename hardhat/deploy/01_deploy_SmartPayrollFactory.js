...
const { smartPayrollFactoryPath, smartPayrollFactoryABI } = require("../utils/config")
const fs = require("fs")
...
module.exports = async ({ deployments, getNamedAccounts }) => {
  ...
  fs.writeFileSync(smartPayrollFactoryABI, smartPayrollFactoryProvider.interface.format(ethers.utils.FormatTypes.json))
